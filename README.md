# microservice-customer (QuietChatter Microservice)

이 저장소는 QuietChatter 프로젝트의 Customer 도메인을 담당하는 마이크로서비스입니다.
레거시 시스템(legacy-quiet-chatter)의 customer 패키지 기능들을 코틀린(Kotlin)과 Spring Boot 3 환경으로 포팅하고 고도화하는 역할을 합니다.
